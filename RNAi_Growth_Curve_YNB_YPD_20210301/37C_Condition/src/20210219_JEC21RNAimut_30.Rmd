...
```{r}
rawdata <- read.csv("~/Documents/Edward Wallace/R/R files/Data/2021/20210219_JEC21RNAimut_30_TD_TRSP.csv")
...
platemap <- read.csv("~/Documents/Edward Wallace/R/R files/Data/2021/20210219_JEC21RNAimut_SetupCSV.csv ")
head(platemap, n=10)
